            ...
            <div className='w-4/5 md:w-full md:h-3/4 p-10 md:p-20'>
                <div className='text-gray-50 md:flex md:flex-row md:items-start md:justify-evenly'>
                    <div className='md:w-1/3 mb-14 md:mb-0'>
                        ...
                        <a target="_blank" href="https://younesakbour.github.io/front-end/"><img className='transition duration-500 ease-in-out hover:scale-110' src={Frontend} alt="frontend" /></a>
                    ...
                    <div className='md:w-1/3'>
                        ...
                        <a target="_blank" href="https://github.com/younesakbour/laravel-ecommerce-cod"><img className='transition duration-500 ease-in-out hover:scale-110' src={Backend} alt="backend" /></a>
